...
export const nodeDefinitions = {
  'nats-broker': {
    ...
    iconColor: '#444',
    inputs: [],
    outputs: [{ id: 'output_0', label: 'Connection', type: 'connection' }],
    defaultData: { url: 'nats://localhost:4222' },
    properties: [{ key: 'url', label: 'URL', type: 'text', placeholder: 'nats://localhost:4222' }]
  },
  'nats-sub': {
    ...
    outputs: [{ id: 'output_0', label: 'Message', type: 'message' }],
    defaultData: { subject: '' },
    properties: [{ key: 'subject', label: 'Subject', type: 'text', placeholder: 'events.>' }]
  },
  'nats-pub': {
  ...
  'mqtt-in': {
    ...
    properties: [{ key: 'topic', label: 'Topic', type: 'text', placeholder: 'sensor/#' }]
  },
  'modbus-read': {
    ...
    iconColor: '#fff',
    inputs: [],
    outputs: [{ id: 'output_0', label: 'Data', type: 'message' }],
  ...
  'rhai-function': {
    ...
    properties: [{ key: 'code', label: 'Rhai Script', type: 'code' }]
  }
};
